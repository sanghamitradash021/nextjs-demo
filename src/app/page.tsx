...
import MealTypeRecipes from '../components/MealtypeRecipe';
import PopularCuisines from '../components/PopularCuisine';
import AllRecipes from '../components/Allrecipes';

export default function Home() {
  return (
    <ThemeProvider>
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12 space-y-16 mt-10">
        <FeaturedCategories />
        <MealTypeRecipes />
        <PopularCuisines />
        <AllRecipes />
